...
export const Route = createFileRoute("/help")({
  ...
  component: () => (
    <PageShell eyebrow="Support" title="Help center" subtitle="Answers to the questions we get most. Can't find yours? Email hello@portfoliohub.app.">
      <div className="space-y-3">
        {[
          ...
          "Where does PortfolioHub host my site?",
        ].map((q) => (
