...
export function AIProduct2Testimonials({ props = { items: [] }, theme, onChange }: Props) {
  ...
  return (
    <section className="w-full px-6 py-24 overflow-hidden transition-colors" style={{ backgroundColor: bg, color: ink }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-6">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={scrollPrev}
              className="h-10 w-10 rounded-xl flex items-center justify-center transition-all hover:scale-105 cursor-pointer border"
          ...
          <div className="flex gap-6 -ml-4">
            {items.map((item, i) => (
              <div key={i} className="flex-[0_0_100%] md:flex-[0_0_50%] pl-4 min-w-0">
                <div
                  className="h-full p-8 sm:p-10 rounded-3xl flex flex-col justify-between border"
                  style={{ backgroundColor: surface, borderColor: surface }}
                >
                  <div>
                    <Quote className="h-6 w-6 mb-4 opacity-40" style={{ color: accent }} />
                    <Editable
                      as="p"
                      value={item.quote}
                  ...
                  <div className="flex items-center gap-4 pt-6 border-t" style={{ borderColor: surface }}>
                    <div
