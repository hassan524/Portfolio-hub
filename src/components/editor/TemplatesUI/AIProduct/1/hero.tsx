...
// Image Carousel Slides for the hero media card
const HERO_SLIDES = [
  {
...
// Logos for the moving marquee carousel
...
export function AIProduct1Hero() {
  ...
  // Auto-rotate the image & content carousel every 4 seconds
  useEffect(() => {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial="initial" animate="animate" className="max-w-xl">
            ...
            <motion.div {...rise} className="flex items-center gap-1.5 mb-6">
              ...
              <span className="text-sm font-semibold text-gray-700">4.7 on TrustPilot • Trusted by 500+ Brands</span>
            </motion.div>

            {/* Heading */}
            <motion.div {...rise} transition={{ ...rise.transition, delay: 0.05 }}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.95] text-gray-900">
                AI-Powered <br />
                AdWords That <br />
                Find Lead
              </h1>
            ...
            <motion.div {...rise} transition={{ ...rise.transition, delay: 0.12 }}>
              <p className="mt-6 text-base md:text-lg leading-relaxed text-gray-600 max-w-md">
          ...
          {/* Right: Moving Image & Content Carousel Card */}
          <motion.div
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Live Metric</span>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-xl p-3 bg-pink-100/80 border border-pink-200/50">
                  ...
                  <span className="text-[10px] font-medium mt-0.5 block text-gray-600">{HERO_SLIDES[currentSlide].statLabel}</span>
                </div>
                <div className="rounded-xl p-3 bg-emerald-100/80 border border-emerald-200/50 flex flex-col justify-between">
                  <div>
                    <span className="text-sm font-bold text-gray-900 block">23.4%</span>
                    <span className="text-[9px] font-medium text-gray-600 block">Added to cart</span>
                  </div>
                  <div className="mt-1 pt-1 border-t border-emerald-200/60">
                    <span className="text-[9px] font-bold text-emerald-700 block">76.6% Active</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-800 leading-snug">Love it! Going to try it out</span>
            </motion.div>

            {/* Bottom Caption Bar with Interactive Carousel Dots */}
