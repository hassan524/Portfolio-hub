  ...
  return (
    <section className="relative px-6 md:px-16 py-32 overflow-hidden transition-colors" style={{ backgroundColor: bg, color: ink }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono tracking-widest uppercase mb-4 backdrop-blur-md" style={{ background: `${accent}15`, color: accent, border: `1px solid ${accent}30` }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <Editable
                ...
                style={{ background: `${accent}10`, color: ink }}
            ...
            <Editable as="p" className="text-sm leading-relaxed max-w-xl mb-8" style={{ color: ink, opacity: 0.75 }}>Every query dynamically constructs an optimized execution graph, routing tokens between fine-tuned open weights and frontier models instantly.</Editable>

            <div className="p-4 rounded-2xl font-mono text-xs space-y-2 backdrop-blur-md" style={{ backgroundColor: `${bg}80`, border: `1px solid ${surface}` }}>
              <div className="flex items-center justify-between pb-2 border-b" style={{ borderColor: surface }}>
                ...
                <Editable as="span" style={{ color: ink, opacity: 0.75 }}>latency: 14.2ms</Editable>
              </div>
              <Editable as="p" style={{ color: ink, opacity: 0.75 }}>$ neural-router --sync --model=v4-turbo --vector-dim=1536</Editable>
          ...
          >
            ...
            <Editable as="p" className="text-sm leading-relaxed" style={{ color: ink, opacity: 0.75 }}>Your data never trains public foundation models. Zero-retention architecture with hardware-enforced AES-256 encryption.</Editable>
          </motion.div>
          ...
          >
            ...
            <Editable as="p" className="text-sm leading-relaxed" style={{ color: ink, opacity: 0.75 }}>Connect PostgreSQL, Snowflake, or Notion. Changes index instantly into vector memory with zero manual cron jobs.</Editable>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <Editable as="span" className="text-xs font-mono" style={{ color: ink, opacity: 0.75 }}>Multi-step reasoning execution</Editable>
              </div>
            </div>
            <Editable as="p" className="text-sm leading-relaxed max-w-xl" style={{ color: ink, opacity: 0.75 }}>Deploy collaborative AI worker pools that execute complex workflows across external APIs, verify outputs through linting checks, and deliver production artifacts autonomously.</Editable>
          </motion.div>
        </div>
      </div>
    </section>
