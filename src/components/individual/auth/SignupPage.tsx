...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* ── Top nav ── */}
      <header className="relative z-10 w-full px-4 sm:px-6 py-3 flex items-center justify-between">
        <Link to="/">
          <img src="/logo.png" alt="Portflu" className="h-7 w-auto object-contain" />
        </Link>
      </header>
        ...
        >
          ...
          <div className="text-center mb-5 sm:mb-6">
            ...
            <p className="mt-2 text-sm text-ink-soft">
              ...
              <Link to="/auth/login" className="font-medium text-foreground underline underline-offset-2 hover:opacity-80">
                Log in
              </Link>
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start gap-0">
            ...
            <div className="w-full md:flex-1">
              <form className="space-y-3" onSubmit={handleSubmit} noValidate>
                  ...
                  <AuthInput
                      ...
                      endAdornment={
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 text-ink-soft hover:bg-transparent hover:text-ink"
                        >
                ...
                <Button
                  ...
                  className="h-9 w-full rounded-md bg-foreground text-background text-sm font-semibold hover:opacity-90"
                >
                  {isSubmitting ? (
            ...
            {/* ── OR divider ── */}
            <div className="flex md:flex-col items-center justify-center w-full md:w-auto my-4 md:my-0 md:mx-6 gap-3 md:gap-0">
              <div className="flex-1 md:flex-none md:h-24 w-full md:w-px bg-border" />
              <span className="text-[11px] font-semibold uppercase tracking-widest text-ink-soft md:my-3">or</span>
              <div className="flex-1 md:flex-none md:h-24 w-full md:w-px bg-border" />
            </div>
            ...
            <div className="w-full md:flex-1 space-y-3">
              ...
              <Button
                ...
                variant="outline"
                className="w-full flex items-center gap-3 rounded-md border-white/10 bg-surface-elevated px-4 py-2.5 text-sm font-medium hover:bg-surface hover:border-white/20"
              >
              ...
              <Button
                ...
                variant="outline"
                className="w-full flex items-center gap-3 rounded-md border-white/10 bg-surface-elevated px-4 py-2.5 text-sm font-medium hover:bg-[#1877F2]/5 hover:border-[#1877F2]"
              >
