        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start gap-0 sm:gap-0">
            ...
            <div className="w-full sm:flex-1">
              <form className="space-y-3" onSubmit={handleSubmit} noValidate>
                ...
                <div>
                  ...
                  {fieldErrors.password && fieldErrors.password !== fieldErrors.email && (
                    <p className="mt-1 flex items-center gap-1 text-xs text-red-500 font-medium">
                      <AlertCircle className="h-3.5 w-3.5 shrink-0" />
                      {fieldErrors.password}
                    </p>
                ...
                >
                  {isSubmitting ? (
                    <><Loader2 className="h-4 w-4 animate-spin shrink-0" /><span>Signing in...</span></>
                  ) : (
            ...
            <div className="flex sm:flex-col items-center justify-center w-full sm:w-auto my-5 sm:my-0 sm:mx-8 gap-3 sm:gap-0">
              <div className="flex-1 sm:flex-none sm:h-20 w-full sm:w-px bg-border" />
            ...
            <div className="w-full sm:flex-1 space-y-2">
              ...
              <button
                ...
                className={`group relative w-full flex items-center gap-3 rounded-lg border px-4 py-2.5 text-sm font-medium transition-all duration-200 cursor-pointer ${
                  rememberedGoogle
                    ? "border-transparent bg-foreground text-background hover:opacity-90"
                    : "border-white/10 bg-surface-elevated hover:bg-surface hover:border-white/20"
                }`}
              >
                ...
                {rememberedGoogle && (
                  <span className="ml-auto text-[9px] font-semibold uppercase tracking-wide opacity-60">Last used</span>
                )}
              </button>
              ...
              <button
                ...
                className={`group relative w-full flex items-center gap-3 rounded-lg border px-4 py-2.5 text-sm font-medium transition-all duration-200 cursor-pointer ${
                  rememberedFacebook
                    ? "border-transparent bg-[#1877F2] text-white hover:opacity-90"
                    : "border-white/10 bg-surface-elevated hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2]"
                }`}
              >
                ...
                {rememberedFacebook && (
                  <span className="ml-auto text-[9px] font-semibold uppercase tracking-wide opacity-70">Last used</span>
                )}
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col items-center gap-1.5">
            ...
            <Link
              to="/"
              className="text-sm text-ink-soft hover:text-ink transition-colors flex items-center gap-1"
            >
              ← Back to Home
            </Link>
          </div>
