      ...
      <div className="relative z-10 max-w-lg">
        ...
        >
          ...
          <span
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.72 0.18 40), oklch(0.82 0.16 75) 60%, oklch(0.88 0.13 95))",
        ...
        >
          Join thousands of creators who use PortfolioHub to showcase their
          work with premium, hand-designed templates. No code, no design skills
          needed.
        </motion.p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-background/40">
              already building with PortfolioHub
            </div>
          </div>
        </div>
      </motion.div>
