  ...
  return (
    <PageShell eyebrow="Legal" title="Refund policy" subtitle="Last updated: July 2026">
      <Prose>
        ...
        <p>Send a short note to <a href="mailto:support@portfoliohub.app">support@portfoliohub.app</a> with your email address and order details. We’ll confirm the refund and return the original payment method where possible.</p>
        <h2>Exceptions</h2>
