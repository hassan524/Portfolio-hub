  ...
  return (
    <PageShell eyebrow="Legal" title="Privacy policy" subtitle="Last updated: July 2026">
      <Prose>
        ...
        <p>We collect the minimum data needed to run your portfolio, we never sell it, and we never use third-party trackers on portfoliohub.app or on the portfolios you publish.</p>
        ...
        <h2>Contact</h2>
        <p>Data privacy questions: <a href="mailto:privacy@portfoliohub.app">privacy@portfoliohub.app</a></p>
      </Prose>
    </PageShell>
  );
}
